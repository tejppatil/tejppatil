...
ROWS = [
    ("host",),
    ("kv", "Recent", "Cybersec Intern @ I4C (MHA)"),
    ("kv", "Prev", "Cybersec Intern @ Secuerium"),
    ("kv", "Edu", "B.Tech CSE (Cybersec) @ RRU '27"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Scripting", "Python, C++, Bash/Shell"),
    ("kv", "Tools", "Nmap, Metasploit, Burp Suite"),
    ("kv", "OS/Distro", "Kali Linux, Ubuntu, VMware"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Winner - HACK IITK CTF 2026 (Rank 1/9000+)"),
    ("bul", "TryHackMe Global Rank - Top 2% (2026)"),
    ("bul", "Google Student Ambassador (Gemini Program)"),
]
